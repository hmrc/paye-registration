...
class RegistrationMongoRepositoryISpec
  ...
  private val companyDetails: CompanyDetails = CompanyDetails(crn = None, companyName = "tstCcompany", tradingName = Some("tstTradingName"), roAddress = address, ppobAddress = address, businessContactDetails = businessContact)
  ...
  private val companyDetails2: CompanyDetails = CompanyDetails(crn = None, companyName = "tstCcompany2", tradingName = Some("tstTradingName2"), roAddress = address, ppobAddress = address, businessContactDetails = businessContact)
